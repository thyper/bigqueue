...
NodesMonitor.prototype.refreshData = function(callback) {
  var self = this;
  console.log("Checking: "+this.clusterUrl);
  ...
  try {
    ...
    if(response.statusCode != 200) {
      throw new Error("Error getting data from ["+this.clusterUrl+"] status ["+response.statusCode+"]"); 
    }
  } catch(e) {
    callback(e);
    try {
    ...
    return console.log("Error getting data from api",e);
  }
