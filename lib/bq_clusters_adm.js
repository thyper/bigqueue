      ...
      function(topics_db, cb) {
        ...
        self.getConsumerByCriteria(criteria, function(err, data) {
          ...
          data.forEach(function(consumer) {
            topics_idx[consumer.topic_id].consumers.push({consumer_id: consumer.consumer_id, consumer_stats: consumer.consumer_stats});
          });
          cb(err);
        });
      }
  ...
  if(criteria) {
    ...
    Object.keys(criteria).forEach(function(e) {
      ...
      if(name.indexOf(".") == -1) {
        ...
        if(name != "cluster" && name != "ttl" && name.lastIndexOf("topic_") != 0) {
          name = "c."+name;
        } else {
          name = "t."+name;
        }
