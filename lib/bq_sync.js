...
BigQueueSync.prototype.fullSync = function(callback) {
  var self = this;
  var errorSend = false;
  var ready = 0;
  var nodeClient;
...
BigQueueSync.prototype.fullStructureSync = function(callback) {
  var self = this;
  var errorSend = false;
  var ready = 0;
  var nodeClient;
  ...
  this.getSyncData(function(err, clusterData, nodeData, journalData) {
    ...
    function onReady() {
      ready++
      if(ready == 2) {
        self.syncStructure(clusterData, nodeClient, callback); 
      }
    }
