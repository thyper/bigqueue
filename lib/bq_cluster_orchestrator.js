...
BigQueueClusterOrchestrator.prototype.checkProperty = function(property){
...
BigQueueClusterOrchestrator.prototype.updateClientStatus = function(clientType,clientId,data,err,callback){
     ...
     */
    if(!this.checkProperty(data.host) || 
            !this.checkProperty(data.port) ||
            !this.checkProperty(data.status) ||
            (clientType == "nodes" && !this.checkProperty(data.journals)) 
        ){
