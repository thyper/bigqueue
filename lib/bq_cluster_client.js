...
BigQueueClusterClient.prototype.nodeAdded = function(node){
    ...
    if(node.path == this.nodesPath){
        this.nodes.push(clusterNode)
        clusterNode["client"] = this.createClientFunction(clusterNode.data)
    }else{
        this.journals.push(clusterNode)
        clusterNode["client"] = this.createJournalFunction(clusterNode.data)
...
BigQueueClusterClient.prototype.nodeRemoved = function(node){
    if(node.path == this.nodesPath){
        this.dataNodeRemoved(node)
    }
}

BigQueueClusterClient.prototype.dataNodeRemoved = function(node){
...
BigQueueClusterClient.prototype.nodeDataChange = function(node){
    if(node.path == this.nodesPath){
        this.dataNodeChange(node)
    }
}


BigQueueClusterClient.prototype.dataNodeChange = function(node){
